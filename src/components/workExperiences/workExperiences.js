  ...
  return (
    <PageTemplate>
      <section className="work-experiences__section">
        <h2> 极狐GitLab(GitLab China) </h2>
        <p>Sr Digital Experience Manager/Sr Backend Engineer 2021.08 - 2023.08</p>
        <p>
          作为 Digital Experience 团队的第二个开发成员加入了极狐GitLab市场部门，完全自主完成了公司内部系统 Partner Portal 从 0 到 1 的开发工作，在一个月的时间完成了的第一个版本的开发和上线。
          在后续的工作中晋升为数字体验部高级经理，带领 Digital Experience 团队服务于多个部门的开发需求，包含但不限于渠道部门，市场部门，战略部门等。
        </p>
        <p>
          我们使用 Agile 的开发模式，代码 merge 到 master/main 分支之后，会触发测试以及自动部署流程，这一切都是基于 GitLab 强大的 CI/CD 功能。
        </p>
        <p>
          在项目中实现了跟多方平台的集成，包含 Salesforce，企查查，米知云，腾讯邮件推送，阿里对象存储等等。
        </p>
        <p>
          除了上述 partner portal 项目的完全自主开发之外，还参与了官网，极狐GitLab SaaS 的日常开发维护工作。
        </p>
      </section>

      <section className="work-experiences__section">
        <h2> 爱齐科技 </h2>
        <p>Full Stack Developer 2018.07 - 2021.08</p>
        <p>
